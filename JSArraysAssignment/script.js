...
console.log("Exercise 1 thru 5 Result:\n", foods);
...
const indexOfPizza = foods.indexOf('pizza');
foods.splice(indexOfPizza, 1, 'sushi', 'cupcake');
console.log("Exercise 6 Reuslt: " + foods);
...
console.log("Exercise 8 Result: Index of 'tofu' in foods array - ", soyIdx)
...
console.log("Exercise 10 Result: Does the array have 'soup'? " + hasSoup);
